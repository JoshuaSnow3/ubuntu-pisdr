...
class pisdr(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._variable_qtgui_range_0_range = Range(1, 10000, 10, freq, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, variable_qtgui_range_0, 1, 0, 0)
